...
return {
  {
    ...
    opts = {
      ...
      -- Aquí es donde personalizamos los colores específicos
      groups = {
        all = {
          -- bg es el color de fondo. Puedes usar nombres de colores
          -- o códigos Hexadecimales como "#3b4252" o "#4e5e70"
          Visual = { bg = "#4e5e70", style = "bold" },
        },
      },
    },
